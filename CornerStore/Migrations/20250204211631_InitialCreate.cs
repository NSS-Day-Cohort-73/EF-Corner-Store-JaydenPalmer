    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 7, 18, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 2, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Hershey's", 3, 1.50m, "Chocolate Bar" },
                    { 4, "Monster", 1, 3.49m, "Energy Drink" },
                    { 5, "Rold Gold", 2, 2.49m, "Pretzels" }
                });
